...
def random_forest_stock():
    """
    Function to perform Random Forest regression analysis on monthly stock prices.
    """
    ...
    df_mensal_predicted.to_csv("/home/useradd/stocks-analysis/data/dados_mensais_predicted_random_forest.csv", index=True)
